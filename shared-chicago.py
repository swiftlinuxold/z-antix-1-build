...
print '***********************************************************************'
print 'CREATING Chicago Swift Linux\n'
print 'Copying files'
	
# Copying ROX wallpaper to /usr/share/wallpaper/
jpg1 = dir_develop + '/wallpaper-chicago/rox-chicago.jpg'
...
jpg1 = dir_develop + '/wallpaper-chicago/login-chicago.jpg'
jpg2 = '/usr/share/slim/themes/antiX/background.jpg'
shutil.copy2 (jpg1, jpg2)

# Copying sound clip to /usr/share/sounds
s1 = dir_develop + '/sound-chicago/sound-chicago.mp3'
s2 = '/usr/share/sounds'
shutil.copy2 (s1, s2)
...
if (not(is_chroot)):
    ...
    text = text.replace('Regular Swift Linux', 'Chicago Swift Linux') 
