...
print '***********************************************************************'
print 'CREATING Minnesota Swift Linux\n'
print 'Copying files'
	
# Copying ROX wallpaper to /usr/share/wallpaper/
jpg1 = dir_develop + '/wallpaper-minnesota/rox-minnesota.jpg'
...
jpg1 = dir_develop + '/wallpaper-minnesota/login-minnesota.jpg'
jpg2 = '/usr/share/slim/themes/antiX/background.jpg'
shutil.copy2 (jpg1, jpg2)

# Copying sound clip to /usr/share/sounds
s1 = dir_develop + '/sound-minnesota/sound-minnesota.mp3'
s2 = '/usr/share/sounds'
shutil.copy2 (s1, s2)
...
if (not(is_chroot)):
    ...
    text = text.replace('Regular Swift Linux', 'Minnesota Swift Linux') 
...
if (not(is_chroot)):
    ...
    text_new=text_new+'mpg123 /usr/share/sounds/sound-minnesota.mp3\n\n'
    text = text.replace(text_old, text_new) 
...
text_new=text_new+'mpg123 /usr/share/sounds/sound-minnesota.mp3\n\n'
text = text.replace(text_old, text_new) 
open('/etc/skel/.icewm/startup', "w").write(text)
